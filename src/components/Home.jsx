...
<div className="bg-white pb-6 sm:pb-8 lg:pb-12 mt-10">
  ...
  <section className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div className="mb-8 flex flex-wrap justify-between md:mb-16">
      <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
        ...
        <p className="max-w-md leading-relaxed text-gray-500 xl:text-lg"></p>
      </div>
...
<div className="bg-white py-6 sm:py-8 lg:py-12">
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="mb-10 md:mb-16">
      <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Products</h2>
    ...
    <div className="grid gap-x-4 gap-y-8 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <div>
        <a href="#" className="group relative mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
          <img src="https://fakestoreapi.com/img/71z3kpMAYsL._AC_UY879_.jpg" loading="lazy" alt="Photo by Austin Wade" className="h-full w-full object-center transition duration-200 group-hover:scale-110" />
        ...
        <div className="flex items-start justify-between gap-2 px-2">
          ...
          <div className="flex flex-col items-end">
            <span className="font-bold text-gray-600 lg:text-lg">$9.85</span>
            <span className="text-sm text-red-500 line-through">$19.99</span>
          </div>
        </div>
      </div>
      ...
      <div>
        <a href="#" className="group relative mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
          <img src="https://fakestoreapi.com/img/71HblAHs5xL._AC_UY879_-2.jpg" loading="lazy" alt="Photo by Nick Karvounis" className="h-full w-full  object-center transition duration-200 group-hover:scale-110" />
        </a>
        ...
        <div className="flex items-start justify-between gap-2 px-2">
          ...
          <div className="flex flex-col items-end">
            <span className="font-bold text-gray-600 lg:text-lg">$39.99</span>
          </div>
        </div>
      </div>
      ...
      <div>
        <a href="#" className="group relative mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
          <img src="https://fakestoreapi.com/img/51Y5NI-I5jL._AC_UX679_.jpg" loading="lazy" alt="Photo by Austin Wade" className="h-full w-full object-center transition duration-200 group-hover:scale-110" />
        </a>
        ...
        <div className="flex items-start justify-between gap-2 px-2">
          ...
          <div className="flex flex-col items-end">
            <span className="font-bold text-gray-600 lg:text-lg">$56.99</span>
          </div>
        </div>
      </div>
      ...
      <div>
        <a href="#" className="group relative mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
          <img src="https://fakestoreapi.com/img/81XH0e8fefL._AC_UY879_.jpg" loading="lazy" alt="Photo by Vladimir Fedotov" className="h-full w-full object-center transition duration-200 group-hover:scale-110" />
        </a>
        ...
        <div className="flex items-start justify-between gap-2 px-2">
          ...
          <div className="flex flex-col items-end">
            <span className="font-bold text-gray-600 lg:text-lg">$29.95</span>
          </div>
        </div>
      </div>
  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div className="flex flex-col overflow-hidden rounded-lg bg-gray-900 sm:flex-row md:h-80">
      ...
      <div className="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-2/5">
        ...
        <p className="mb-8 max-w-md text-gray-400"></p>
...
<div className="bg-white pt-4 sm:pt-10 lg:pt-12">
  <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="border-t py-8 text-center text-sm text-gray-400">© 2021 - Present Tienda. All rights reserved.</div>
  </footer>
</div>
